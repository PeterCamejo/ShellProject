...
{
  "$end", "error", "$undefined", "NUMBER", "HELLO", "STATE", "BYE",
  "COMMAND", "$accept", "commands", "command", "hello_case", "bye_case",
  "state_number_case", YY_NULLPTR
};
#endif
...
#line 34 "shell.y" /* yacc.c:1646  */
    {printf("\t state with number recieved \n"); return 0;}
